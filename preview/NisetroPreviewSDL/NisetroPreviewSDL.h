...
#define VIDEO_FRAME_SEGMENT_WIDTH	8
#define VIDEO_FRAME_PIXELS			VIDEO_FRAME_LINES * VIDEO_FRAME_WIDTH

#define VIDEO_FRAME_LOGICAL_WIDTH	(VIDEO_FRAME_VALID_WIDTH + VIDEO_FRAME_SEGMENT_WIDTH)
#define VIDEO_FRAME_LOGICAL_HEIGHT	(VIDEO_FRAME_VALID_LINES)
#define KERORICAN_FRAME_LOGICAL_WIDTH	272		// 232 * KERORICAN_ROTATE_COSINE + 144 * KERORICAN_ROTATE_SINE
#define KERORICAN_FRAME_LOGICAL_HEIGHT	233		// 232 * KERORICAN_ROTATE_SINE + 144 * KERORICAN_ROTATE_COSINE
...
#define KERORICAN_FRAME_RATIO		0.2368421052631578947368421052631 // (VIDEO_FRAME_LOGICAL_HEIGHT / (VIDEO_FRAME_LOGICAL_WIDTH * 2.0f + VIDEO_FRAME_LOGICAL_HEIGHT))
...
private:
	static const uint8_t segment_bg_bitmap[225942];
	static const uint8_t segment_icon_bitmap[225942];
